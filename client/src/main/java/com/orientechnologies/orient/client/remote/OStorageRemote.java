            ...
            try {
                ...
                try {
                    ...
                    if (iTx.getCurrentRecordEntries().iterator().hasNext()) {
                        for (ORecordOperation txEntry : iTx.getCurrentRecordEntries()) committedEntries.add(txEntry);
            ...
            try {
                ...
                if (result == 1) {
                    ...
                    if (configuration.clusters.size() > iClusterId)
                        // endResponse must be called before this line, which call updateRecord
    ...
    public void updateClusterConfiguration(final String iConnectedURL, final byte[] obj) {
        ...
        synchronized (serverURLs) {
            ...
            if (members != null) {
                ...
                for (ODocument m : members) if (m != null && !serverURLs.contains((String) m.field("name"))) {
