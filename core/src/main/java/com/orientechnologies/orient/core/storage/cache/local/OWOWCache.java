    ...
    public void run() {
      ...
      try {
        ...
        if (lsnFlushInterval >= lsnFlushIntervalBoundary || segmentCount > lastSegmentCount) {
          ...
          if (lsnEntry != null && segmentCount > 65_536 && lsnEntry.getKey() < endSegment) {
